<div class="container-fluid">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td onclick="javascript: return confirm('apakah anda yakin?')"><?php echo anchor('admin/data_barang/hapus/'.$brg->id_brg,'<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>'); ?></td>
        </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(). 'index.php/admin/data_barang/tambah_aksi' ?>">
