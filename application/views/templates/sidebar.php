<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Elektronik -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('index.php/kategori/elektronik') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('index.php/kategori/pakaian_anak_anak') ?>">
                    <i class="fas fa-fw fa-tshirt"></i>
                    <span>Pakaian Anak-anak</span></a>
            </li>
            <!-- Nav Item - Peralatan Olahraga -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('index.php/kategori/peralatan_olahraga') ?>">
